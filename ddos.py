...
if __name__ == "__main__":
    ...
    while True:  # Vòng lặp vô hạn
        try:
            processes = []  # Reset danh sách tiến trình cho mỗi vòng lặp
            ...
            print("Completed one attack cycle. Starting next cycle...")
            time.sleep(1)  # Độ trễ giữa các chu kỳ để tránh quá tải
        except KeyboardInterrupt:
            print("\nStopping the attack...")
            for process in processes:
                process.terminate()  # Dừng các tiến trình khi nhấn Ctrl+C
            break
